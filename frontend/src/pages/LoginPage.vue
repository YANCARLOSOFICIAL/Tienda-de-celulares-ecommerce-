    ...
    <div class="max-w-md w-full mx-auto px-4">
      <div class="bg-surface-dim border border-border rounded-2xl p-8">
        <div class="text-center mb-8">
          <h1 class="text-3xl font-semibold tracking-tight text-white" style="font-family: var(--font-family-serif);">Iniciar sesión</h1>
        ...
        <form class="space-y-4" @submit.prevent="submit">
          ...
          <button
            ...
            class="btn-gold w-full flex items-center justify-center gap-2"
          >
        ...
        <div class="mt-6 flex flex-col items-center gap-3">
          ...
          <p class="text-sm text-text-secondary">
            ¿No tienes cuenta?
            <router-link to="/register" class="text-gold font-medium hover:underline">Regístrate aquí</router-link>
          </p>
        </div>
      </div>
    </div>
